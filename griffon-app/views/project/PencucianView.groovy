    ...
    panel(id: 'mainPanel') {
        ...
        taskPane(id: "form", layout: new MigLayout('hidemode 2', '[right][left][left,grow]', ''), constraints: PAGE_END) {
            ...
            panel(constraints: 'span, growx, wrap') {
                flowLayout(alignment: FlowLayout.LEADING)
                button('Order Telah Selesai Dicuci...', actionPerformed: {
                    if (JOptionPane.showConfirmDialog(mainPanel, "Apakah Anda yakin order ini sudah selesai dicuci pada tanggal ${model.tanggal.toString('dd-MM-yyyy')}?",
