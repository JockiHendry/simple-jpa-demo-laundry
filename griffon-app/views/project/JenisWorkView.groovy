    ...
    panel(id: 'mainPanel') {
        ...
        panel(constraints: CENTER) {
            ...
            scrollPane(constraints: CENTER) {
                glazedTable(id: 'table', list: model.jenisWorkList, sortingStrategy: SINGLE_COLUMN, onValueChanged: controller.tableSelectionChanged) {
