...
class PelangganTest extends DbUnitTestCase {

    private static final Logger log = LoggerFactory.getLogger(PelangganTest)

    protected void setUp() {
        super.setUp()
        setUpDatabase("pelanggan", "/project/data.xls")
