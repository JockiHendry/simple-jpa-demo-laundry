...
class ItemPakaianTest extends DbUnitTestCase {

    private static final Logger log = LoggerFactory.getLogger(ItemPakaianTest)

    protected void setUp() {
        super.setUp()
        setUpDatabase("itemPakaian", "/project/data.xls")
